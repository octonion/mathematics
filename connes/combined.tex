...
\newblock \emph{Advanced Nonlinear Studies} \textbf{20} (2020), no.~3, 633--650.
\newblock arXiv:1909.12194; DOI:10.1515/ans-2020-2091. See Theorem~2.3 and Proposition~2.4 for the positivity improving and simplicity results used in \S\ref{sec:PF}.

\bibitem{ABHN}
W.~Arendt, C.~J.~K.~Batty, M.~Hieber, and F.~Neubrander.
\newblock \emph{Vector-valued Laplace Transforms and Cauchy Problems}.
\newblock 2nd ed., Monographs in Mathematics~96, Birkh\"auser/Springer Basel, 2011.
\newblock DOI:10.1007/978-3-0348-0087-7.

\bibitem{FOT}
M.~Fukushima, Y.~Oshima, and M.~Takeda.
\newblock \emph{Dirichlet Forms and Symmetric Markov Processes}.
\newblock 2nd revised and extended ed., De Gruyter Studies in Mathematics~19, Walter de Gruyter, 2011.
\newblock DOI:10.1515/9783110889741. See Theorem~1.6.1 for the invariant set/ideal characterization used in the irreducibility argument.
